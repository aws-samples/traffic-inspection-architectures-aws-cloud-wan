...
# --- centralized_outbound_region_without_inspection/outputs.tf ---

output "policy" {
  value = data.aws_networkmanager_core_network_policy_document.policy.json
}
...
#     }
#     london_spokes = { for k, v in module.london_spoke_vpcs : k => v.vpc_attributes.id }
#   }
# }